...
// const data = server.createServer((Request,Response)=>{
//     Response.end('Mai hu yaha ka don')
// });
...
const data = server.createServer((request,response)=>{
    ...
    response.end(JSON.stringify(arr, null, 2));

});

data.listen(3000,()=>{
    console.log('Hii i am port number of 3000')
})