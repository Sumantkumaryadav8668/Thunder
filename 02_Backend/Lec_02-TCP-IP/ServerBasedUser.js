               // Handal server according to user's input and normalize this code
...
let app = server.createServer((req,res)=>{
  ...
  if(isNaN(number) || number <= 0){
    res.end('Invalied URL,please check URL')
    return
  }

  if(number > github.length){
    res.end(`you could not find data more than ${github.length}`)
    return
  }
...
app.listen(60,()=>{
  console.log('i am listenning for port number 60')
})